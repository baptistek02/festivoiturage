<?php
    ...
    // page des annonces propres à chaque utilisateur (connexion requis)
    // pour la création d'une annonce propre à chaque utilisateur à part l'admin, le meme formulaire que l'admin est utilisé
    ...
    include("../../controlleurs/client/annonces.php");
...
<body>
    ...
    <div class="ajout-container">
        ...
        <a href="../admin/FormulaireVehicule.php">Ajouter une annonce</a>
    </div>
    <div class="table-container">
        <table>
            ...
            <?php while($row = $annonces->fetch_array()){ ?>
                <tr>
